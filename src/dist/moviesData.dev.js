...
var moviesData = [{
  ...
  adult: false,
  overview: "Based on the true story, international historical project “Sobibor” is dedicated to the heroism of the Soviet o cer Alexander Pechersky. During the great Patriotic war, being in a Nazi concentration camp Sobibor he managed to do the impossible — for only three weeks to organize a revolt and mass escape of the prloadingers. Part of the escapees were caught and shot, and the rest led by Pechersky managed to escape and joined the partisans.",
  release_date: "2018-05-03"
}];
